...
public class OpenIndirectCollaboratorsViewPart extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(OpenIndirectCollaboratorModelProvider.INSTANCE
				.getCollaborators());
	...
	private void createColumns(final Composite parent, final TableViewer viewer) {
		String[] titles = { "Name of the Collaborator", "Artifact Name::1",
				"Artifact Name::2", "Artifact Name::3", "Artifact Name::4" };
