...
public class EntryFormRegProject {
	...
	static String regProjectName= null;
		...
		{
		JFrame frame = new JFrame("Register Project: Admin");
		...
		registerButton.addActionListener(
				new ActionListener(){
					public void actionPerformed(
						...
						{
						// call the regHttpClient here- which calls the regProjectServlet
						//which creates table for the regProject_projectName 
							//also caretes userDetails_projectname table
						// send the parameters ...
						// write to file in the servlet
						try {
							regObject.setConfigProjectValues(projectText.getText(), ownerText.getText(), serverText.getText(), DBserverText.getText());
