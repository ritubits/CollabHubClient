...
public enum DirectCollaboratorModelProvider {
	INSTANCE;
	...
	private DirectCollaboratorModelProvider() {
	...
	public void getCollaboratorsFromServlet() {
		...
		HttpGet httpget = new HttpGet("http://" + ipAddTomcat
				+ "/collabserver/EDCServlet?cName=" + collabName);
			...
			while (true) {
				...
				try {
					...
					if (collabClient != null) {
						...
						// if (DirectCollaboratorsViewPart.viewer!=null)
						// DirectCollaboratorsViewPart.viewer.refresh();
					}
