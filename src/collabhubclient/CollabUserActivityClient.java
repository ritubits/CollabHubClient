...
public class CollabUserActivityClient {
	...
	public boolean updateUserActivityTable() throws Exception {
		...
		HttpGet httpget = new HttpGet("http://" + ipAddT
				+ "/collabserver/UserActivityServlet?&cName=" + collabName
				+ "&" + send);
		if (DEBUG)
			System.out.println("Invoking Servlet:: " + "http://" + ipAddT
					+ "/collabserver/UserActivityServlet?&cName=" + collabName
					+ "&" + send);
	...
	public boolean sendUserArtifactGraphContent(String fileContent,
		...
		String response = executeMultiPartRequest("http://" + ipAddT
				+ "/collabserver/UserArtifactGraphServlet", file, fileName,
				"File Upload");
		System.out.println("Response : " + response + "from client: "
				+ collabName);
	...
	public String executeMultiPartRequest(String urlString, File file,
		...
		try {
			...
			multipartEntity.addBinaryBody("upfile", file,
					ContentType.DEFAULT_BINARY, fileName + "|" + collabName);
			multipartEntity.addTextBody("text", "FileUpload",
