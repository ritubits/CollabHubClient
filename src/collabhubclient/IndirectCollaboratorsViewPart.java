...
public class IndirectCollaboratorsViewPart extends ViewPart{
	...
	public void createPartControl(Composite parent) {
		...
		column3.setText("Mode [Open/Edit]");
		...
		row1.setText(new String[] { "Vinita", "rectangle.java", "Edit", "Method::setData()", "Line No:: 22" });
		row2.setText(new String[] { "Sagar","triangle.java", "Edit", "Method::fillColor()", "Line No:: 92" });
		row3.setText(new String[] { "Shekhar","rectangle.java", "Edit", "Method::getColor()", "Line No:: 23" });
		row4.setText(new String[] { "Mihir","square.java", "Edit", "Method::drawShape()", "Line No:: 11" });
		row5.setText(new String[] { "Sagar","triangle.java", "Open", "None", "Line No:: 00" });
