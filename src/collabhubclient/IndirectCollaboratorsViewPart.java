...
public class IndirectCollaboratorsViewPart  extends ViewPart{
	...
	//	Table table = new Table(parent, SWT.SINGLE);
		...
		Display display= table.getDisplay();
		 ...
		 viewer.setInput(IndirectCollaboratorModelProvider.INSTANCE.getIndirectCollaborators());
	...
	public void setFocus() {
	 ...
	 private void createColumns(final Composite parent, final TableViewer viewer) {
		    String[] titles = { "Name of the Collaborator","Artifact Name", "Current AST Element", "Current Line No." };
