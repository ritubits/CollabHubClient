...
public class ScheduledSimulationUIJob extends Job {
	...
	public boolean setContentData() {
		...
		if (setContentDataJob == null) {
			setContentDataJob = new UIJob(Display.getDefault(), "Setting Data") {
				@Override
	...
	public void setCurrentWorkSpaceContent() {
		...
		if (activeEditor instanceof JavaEditor) {
			...
			if (editor != null) {
				...
				int lineNumber = Integer.parseInt(getLineNumberFromFile());
				// set to a random value between 1 and fileLength
				try {
