...
public class StartCollabPreferencePage extends FieldEditorPreferencePage
		implements IWorkbenchPreferencePage {

	protected void createFieldEditors() {
		addField(new StringFieldEditor("projectName", "Enter Project Name:",
				getFieldEditorParent()));
		addField(new StringFieldEditor("collabName",
				"Enter Collaborator Name:", getFieldEditorParent()));
		...
		addField(new StringFieldEditor("mySQLIP", "Enter MySQL IP address:",
				getFieldEditorParent()));
		addField(new StringFieldEditor("simulationMode",
				"Simulation Mode (Y/N):", getFieldEditorParent()));
		addField(new StringFieldEditor("simulationPath", "Simulation Path:",
				getFieldEditorParent()));
	}
